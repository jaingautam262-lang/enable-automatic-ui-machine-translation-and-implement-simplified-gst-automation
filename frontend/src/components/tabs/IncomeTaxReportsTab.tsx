...
import { Calculator, FileText, TrendingUp, Scale } from 'lucide-react';
...
export default function IncomeTaxReportsTab() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-3xl font-bold tracking-tight">Income Tax Reports</h2>
        <p className="text-muted-foreground">Calculate and compare income tax under different regimes</p>
      </div>
        ...
        <TabsContent value="calculator" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Calculate your tax liability with surcharge, cess, and rebates</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="grid gap-4 md:grid-cols-2">
                ...
                <div className="space-y-2 md:col-span-2">
                  ...
                  <Select value={taxRegime} onValueChange={(v) => setTaxRegime(v as 'old' | 'new')}>
                    ...
                    <SelectContent>
                      <SelectItem value="new">New Tax Regime (FY 2023-24)</SelectItem>
              ...
              {(oldRegimeResult || newRegimeResult) && (
                <div className="border-t pt-4 space-y-4">
                  <h3 className="font-semibold text-lg">Tax Calculation Summary</h3>
                  ...
                  {newRegimeResult && (
                    <div className="space-y-2">
                      ...
                      <div className="flex justify-between">
                        <span>Total Tax:</span>
                        <span className="font-semibold">{formatCurrency(newRegimeResult.totalTax)}</span>
                      </div>
                      {newRegimeResult.rebate > 0 && (
                        <div className="flex justify-between text-green-600">
                          <span>Rebate u/s 87A:</span>
                          <span>- {formatCurrency(newRegimeResult.rebate)}</span>
                        </div>
                      )}
        ...
        <TabsContent value="comparison" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Compare tax liability under both old and new regimes</CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <TabsContent value="deductions" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Track deductions under sections 80C to 80U</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="text-center py-8 text-muted-foreground">
                <FileText className="h-12 w-12 mx-auto mb-4 opacity-50" />
                <p>No deductions recorded yet</p>
                <p className="text-sm mt-2">Add deductions to track your tax savings</p>
              </div>
            </CardContent>
          </Card>
        </TabsContent>

...
export class Backend implements backendInterface {
    ...
    async getPersistedTranslations(): Promise<Array<PersistedTranslation>> {
        if (this.processError) {
            try {
                const result = await this.actor.getPersistedTranslations();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getTranslation(arg0: string, arg1: string): Promise<string | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getTranslation(arg0, arg1);
    ...
    async persistAutoGeneratedTranslation(arg0: string, arg1: string, arg2: string, arg3: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.persistAutoGeneratedTranslation(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");

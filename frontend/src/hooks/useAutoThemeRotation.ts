...
const THEME_VARIANTS: ThemeVariant[] = [
  {
    id: 'coral-sunset',
    name: 'Coral Sunset',
    lightBg: 'linear-gradient(135deg, oklch(0.95 0.08 30) 0%, oklch(0.92 0.12 50) 100%)',
    darkBg: 'linear-gradient(135deg, oklch(0.25 0.08 30) 0%, oklch(0.20 0.12 50) 100%)',
  },
  {
    id: 'ocean-breeze',
    name: 'Ocean Breeze',
    lightBg: 'linear-gradient(135deg, oklch(0.94 0.06 200) 0%, oklch(0.90 0.10 220) 100%)',
    darkBg: 'linear-gradient(135deg, oklch(0.22 0.06 200) 0%, oklch(0.18 0.10 220) 100%)',
  },
  {
    id: 'forest-mist',
    name: 'Forest Mist',
    lightBg: 'linear-gradient(135deg, oklch(0.93 0.07 150) 0%, oklch(0.89 0.11 170) 100%)',
    darkBg: 'linear-gradient(135deg, oklch(0.23 0.07 150) 0%, oklch(0.19 0.11 170) 100%)',
  },
  {
    id: 'lavender-dream',
    name: 'Lavender Dream',
    lightBg: 'linear-gradient(135deg, oklch(0.94 0.08 290) 0%, oklch(0.91 0.10 310) 100%)',
    darkBg: 'linear-gradient(135deg, oklch(0.24 0.08 290) 0%, oklch(0.20 0.10 310) 100%)',
  },
  {
    id: 'amber-glow',
    name: 'Amber Glow',
    lightBg: 'linear-gradient(135deg, oklch(0.95 0.10 70) 0%, oklch(0.92 0.12 85) 100%)',
    darkBg: 'linear-gradient(135deg, oklch(0.25 0.10 70) 0%, oklch(0.21 0.12 85) 100%)',
  },
];

...
import GSTSuiteTab from "../components/tabs/GSTSuiteTab";
  ...
  const navGroups = [
    ...
    },
    {
      ...
      items: [
        ...
        { value: "gst-suite", icon: ShieldCheck, label: "GSP Suite" },
    ...
    <div className="min-h-screen bg-background">
      <div className="container mx-auto p-4 space-y-4">
        ...
        >
          ...
          <TabsContent value="gst-purchase">
            <GSTPurchaseInvoicesTab />
          </TabsContent>
          <TabsContent value="gst-automation">
            <GSTAutomationTab />
          </TabsContent>
          <TabsContent value="gst-suite">
            <GSTSuiteTab />
          </TabsContent>
          <TabsContent value="tax-rates">
            <TaxRateManagementTab />
          </TabsContent>
          ...
          <TabsContent value="calculators">
            <FinancialCalculatorsTab />
          </TabsContent>
          <TabsContent value="ca-consultation">
            <CAConsultationTab />
          </TabsContent>
          <TabsContent value="ca-admin">
            <CAProfileManagementTab />
          </TabsContent>

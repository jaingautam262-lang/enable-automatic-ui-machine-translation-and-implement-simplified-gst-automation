...
export default function FinancialCalculatorsTab() {
  ...
  const calculateEMI = () => {
    const principal = Number.parseFloat(emiData.principal);
    const annualRate = Number.parseFloat(emiData.rate);
    const tenure = Number.parseInt(emiData.tenure);
    ...
    if (emiData.mode === "standard") {
      ...
      const quarterlyInstallment =
        (principal * quarterlyRate * (1 + quarterlyRate) ** quarters) /
        ((1 + quarterlyRate) ** quarters - 1);
      ...
      monthlyInstallment =
        (principal * monthlyRate * (1 + monthlyRate) ** regularMonths) /
        ((1 + monthlyRate) ** regularMonths - 1);
      let balance = principal;
  ...
  const calculateMPBF = () => {
    const currentAssets = Number.parseFloat(mpbfData.currentAssets);
    const currentLiabilities = Number.parseFloat(mpbfData.currentLiabilities);
    const inventoryHoldingPeriod =
      Number.parseFloat(mpbfData.inventoryHoldingPeriod) || 0;
    const receivablesCollectionPeriod =
      Number.parseFloat(mpbfData.receivablesCollectionPeriod) || 0;
    const payablesPaymentPeriod =
      Number.parseFloat(mpbfData.payablesPaymentPeriod) || 0;
  ...
  const calculateCMA = () => {
    const salesProjection = Number.parseFloat(cmaData.salesProjection);
    const purchaseProjection = Number.parseFloat(cmaData.purchaseProjection);
    const inventoryProjection =
      Number.parseFloat(cmaData.inventoryProjection) || 0;
    const receivablesProjection =
      Number.parseFloat(cmaData.receivablesProjection) || 0;
    const payablesProjection =
      Number.parseFloat(cmaData.payablesProjection) || 0;
    ...
    const workingCapitalRequirement =
      inventoryProjection + receivablesProjection - payablesProjection;
  ...
  const calculateIRR = () => {
    const initialInvestment = Number.parseFloat(irrData.initialInvestment);
    const cashFlows = irrData.cashFlows.map((cf) => Number.parseFloat(cf) || 0);
    const discountRate = Number.parseFloat(irrData.discountRate) / 100;
    ...
    for (let i = 0; i < 100; i++) {
      ...
      cashFlows.forEach((cf, index) => {
        ...
        npvAtIRR += cf / (1 + irr) ** period;
        derivative -= (period * cf) / (1 + irr) ** (period + 1);
      });
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Advanced EMI, IRR, MPBF, CMA, and Financial Ratio calculators with
            INR formatting
          </p>
        </div>
      </div>
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Calculate monthly installments with multiple modes
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setEmiData({ ...emiData, principal: e.target.value })
                    }
                  />
                </div>
                <div className="space-y-2">
            ...
            {emiResult && (
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Calculated installment details
                  </CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                  <div className="space-y-3">
                    <div className="flex justify-between p-3 bg-primary/5 rounded-lg">
                      ...
                      <span className="font-bold text-primary">
                        {formatINR(emiResult.monthlyInstallment)}
                      </span>
                    </div>
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium">
                        {formatINR(emiResult.totalRepayment)}
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-2 pt-4">
                    <Button
                      ...
                      size="sm"
                      className="flex-1"
                      onClick={() => handlePrint("EMI Calculator")}
                    >
                    ...
                    <Button
                      ...
                      size="sm"
                      className="flex-1"
                      onClick={() => handleExportPDF("EMI Calculator")}
                    >
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Maximum Permissible Bank Finance calculation
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="space-y-2">
                ...
                <div className="space-y-2">
                  <Label htmlFor="inventoryHoldingPeriod">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setMpbfData({
                        ...mpbfData,
                        inventoryHoldingPeriod: e.target.value,
                      })
                    }
                  />
                </div>
                <div className="space-y-2">
                  <Label htmlFor="receivablesCollectionPeriod">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setMpbfData({
                        ...mpbfData,
                        receivablesCollectionPeriod: e.target.value,
                      })
                    }
                  />
                </div>
                <div className="space-y-2">
                  <Label htmlFor="payablesPaymentPeriod">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setMpbfData({
                        ...mpbfData,
                        payablesPaymentPeriod: e.target.value,
                      })
                    }
                  />
                </div>
                ...
                <CardContent className="space-y-4">
                  <div className="space-y-3">
                    <div className="flex justify-between p-3 bg-primary/5 rounded-lg">
                      ...
                      <span className="font-bold text-primary">
                        {formatINR(mpbfResult.mpbfAmount)}
                      </span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-muted-foreground">
                      ...
                      <span className="font-medium">
                        {formatINR(mpbfResult.workingCapital)}
                      </span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-muted-foreground">
                      ...
                      <span className="font-medium">
                        {mpbfResult.cashConversionCycle.toFixed(0)} days
                      </span>
                    </div>
                  </div>
                  <div className="flex gap-2 pt-4">
                    <Button
                      ...
                      size="sm"
                      className="flex-1"
                      onClick={() => handlePrint("MPBF Calculator")}
                    >
                      <Printer className="h-4 w-4 mr-2" />
                      Print
                    </Button>
                    <Button
                      ...
                      size="sm"
                      className="flex-1"
                      onClick={() => handleExportPDF("MPBF Calculator")}
                    >
                      <Download className="h-4 w-4 mr-2" />
                      Export PDF
                    </Button>
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setCmaData({
                        ...cmaData,
                        salesProjection: e.target.value,
                      })
                    }
                  />
                </div>
                <div className="space-y-2">
                  <Label htmlFor="purchaseProjection">
                    Purchase Projection (₹)
                  </Label>
                  <Input
                    ...
                    onChange={(e) =>
                      setCmaData({
                        ...cmaData,
                        purchaseProjection: e.target.value,
                      })
                    }
                  />
                </div>
                <div className="space-y-2">
                  <Label htmlFor="inventoryProjection">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setCmaData({
                        ...cmaData,
                        inventoryProjection: e.target.value,
                      })
                    }
                  />
                </div>
                <div className="space-y-2">
                  <Label htmlFor="receivablesProjection">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setCmaData({
                        ...cmaData,
                        receivablesProjection: e.target.value,
                      })
                    }
                  />
                </div>
                <div className="space-y-2">
                  <Label htmlFor="payablesProjection">
                    Payables Projection (₹)
                  </Label>
                  <Input
                    ...
                    onChange={(e) =>
                      setCmaData({
                        ...cmaData,
                        payablesProjection: e.target.value,
                      })
                    }
                  />
                </div>
                ...
                <CardContent className="space-y-4">
                  <div className="space-y-3">
                    <div className="flex justify-between p-3 bg-primary/5 rounded-lg">
                      ...
                      <span className="font-bold text-primary">
                        {formatINR(cmaResult.cashFlowProjection)}
                      </span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-muted-foreground">
                      ...
                      <span className="font-medium">
                        {formatINR(cmaResult.workingCapitalRequirement)}
                      </span>
                    </div>
                  </div>
                  <div className="flex gap-2 pt-4">
                    <Button
                      ...
                      size="sm"
                      className="flex-1"
                      onClick={() => handlePrint("CMA Calculator")}
                    >
                      <Printer className="h-4 w-4 mr-2" />
                      Print
                    </Button>
                    <Button
                      ...
                      size="sm"
                      className="flex-1"
                      onClick={() => handleExportPDF("CMA Calculator")}
                    >
                      <Download className="h-4 w-4 mr-2" />
                      Export PDF
                    </Button>
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Internal Rate of Return and NPV calculation
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="space-y-2">
                ...
                {irrData.cashFlows.map((cf, index) => (
                  ...
                  <div key={index} className="space-y-2">
                    <Label htmlFor={`cashFlow${index}`}>
                      Year {index + 1} Cash Flow (₹)
                    </Label>
                    <Input
                      id={`cashFlow${index}`}
                      type="number"
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setIrrData({ ...irrData, discountRate: e.target.value })
                    }
                  />
                </div>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="flex gap-2 pt-4">
                    <Button
                      ...
                      size="sm"
                      className="flex-1"
                      onClick={() => handlePrint("IRR Calculator")}
                    >
                      <Printer className="h-4 w-4 mr-2" />
                      Print
                    </Button>
                    <Button
                      ...
                      size="sm"
                      className="flex-1"
                      onClick={() => handleExportPDF("IRR Calculator")}
                    >
                      <Download className="h-4 w-4 mr-2" />
                      Export PDF
                    </Button>

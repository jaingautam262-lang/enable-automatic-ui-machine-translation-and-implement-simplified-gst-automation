...
export default function CAConsultationTab() {
  ...
  const handleUpdateContactInfo = async () => {
    ...
    if (
      !editedContactInfo.name ||
      !editedContactInfo.firmName ||
      !editedContactInfo.phone ||
      !editedContactInfo.email
    ) {
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">
          Professional communication and document sharing with Chartered
          Accountants
        </p>
      </div>
      ...
      {consultations.length === 0 ? (
        <Alert>
          ...
          <AlertDescription>
            You don't have any active consultations yet. Contact your
            administrator to set up a consultation with a Chartered Accountant.
          </AlertDescription>
        </Alert>
      ) : (
        <div className="grid gap-6 lg:grid-cols-3">
          ...
          <Card className="lg:col-span-2">
            ...
            <CardContent className="space-y-4">
                ...
                <Card className="border-primary/20 bg-primary/5">
                      ...
                      {isAdmin && (
                        ...
                        >
                          ...
                          <DialogContent>
                            <DialogHeader>
                              <DialogTitle>
                                Edit CA Contact Information
                              </DialogTitle>
                              <DialogDescription>
                                Update the contact details for the Chartered
                                Accountant
                              </DialogDescription>
                            </DialogHeader>
                  ...
                  <CardContent className="space-y-2 text-sm">
                    <div className="flex items-center gap-2">
                      ...
                      <span>
                        {selectedConsultation.caContactInfo.name || "Not set"}
                      </span>
                    </div>
                    <div className="flex items-center gap-2">
                      ...
                      <span>
                        {selectedConsultation.caContactInfo.firmName ||
                          "Not set"}
                      </span>
                    </div>
                    <div className="flex items-center gap-2">
                      ...
                      <span>
                        {selectedConsultation.caContactInfo.phone || "Not set"}
                      </span>
                    </div>
                    <div className="flex items-center gap-2">
                      ...
                      <span>
                        {selectedConsultation.caContactInfo.email || "Not set"}
                      </span>
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-lg font-semibold text-primary">
                          {formatCurrency(
                            selectedConsultation.consultationFees,
                          )}
                        </span>
                      </div>
                      {isAdmin && (
              ...
              {/* Shared Documents */}
              {selectedConsultation &&
                selectedConsultation.sharedDocuments.length > 0 && (
                  <div className="space-y-2">
                    <Label className="text-sm font-semibold">
                      Shared Documents
                    </Label>
                    <div className="flex flex-wrap gap-2">
                      {selectedConsultation.sharedDocuments.map(
      ...
      <Card className="border-primary/20 bg-primary/5">
        ...
        <CardContent className="space-y-2 text-sm text-muted-foreground">
          <p>
            <strong>Professional Communication:</strong> Secure messaging system
            for direct communication with your Chartered Accountant
          </p>
          <p>
            <strong>CA Contact Details:</strong> View and manage CA contact
            information including name, firm, phone, and email
          </p>
          <p>
            <strong>Consultation Fees:</strong> Track and manage consultation
            fees with proper INR formatting
          </p>
          <p>
            <strong>Document Sharing:</strong> Upload and share financial
            documents, reports, and supporting materials
          </p>
          <p>
            <strong>Audit Support:</strong> Collaborate on audit preparation,
            compliance checks, and financial reviews
          </p>
          <p>
            <strong>Real-time Updates:</strong> Get instant notifications when
            your CA responds or shares documents
          </p>
        </CardContent>
      </Card>
    </div>

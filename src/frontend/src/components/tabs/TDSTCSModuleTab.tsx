...
} from "../../hooks/useTDSTCSPersistence";
...
export default function TDSTCSModuleTab() {
  ...
  const handleAddTDS = async () => {
    ...
    const sectionData = TDS_SECTIONS.find(
      (s) => s.section === tdsFormData.section,
    );
    if (!sectionData) {
    ...
    try {
      if (editingTDS) {
        await updateTDS(editingTDS.id, {
          ...
          transactionId: tdsFormData.linkedTransactionId
            ? BigInt(tdsFormData.linkedTransactionId)
            : editingTDS.transactionId,
        });
  ...
  const handleAddTCS = async () => {
    ...
    const sectionData = TCS_SECTIONS.find(
      (s) => s.section === tcsFormData.section,
    );
    if (!sectionData) {
    ...
    try {
      if (editingTCS) {
        await updateTCS(editingTCS.id, {
          ...
          transactionId: tcsFormData.linkedTransactionId
            ? BigInt(tcsFormData.linkedTransactionId)
            : editingTCS.transactionId,
        });
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Tax Deducted at Source and Tax Collected at Source compliance with
            Income Tax & GST integration
          </p>
        </div>
      </div>
            ...
            <CardHeader>
              <div className="flex items-center justify-between">
                ...
                <div className="flex gap-2">
                  <Select
                    value={filterLinked}
                    onValueChange={(value: any) => setFilterLinked(value)}
                  >
                  ...
                  >
                    ...
                    <DialogContent className="max-w-2xl">
                      <DialogHeader>
                        ...
                        <DialogDescription>
                          Record a TDS deduction with optional invoice/purchase
                          linking
                        </DialogDescription>
                      </DialogHeader>
                  ...
                  >
                    ...
                    <DialogContent className="max-w-2xl">
                      <DialogHeader>
                        ...
                        <DialogDescription>
                          Record a TCS collection with optional invoice/sale
                          linking
                        </DialogDescription>
                      </DialogHeader>
                      <div className="space-y-4 py-4">
          ...
          <Alert>
            ...
            <AlertDescription>
              ...
              <ul className="list-disc list-inside mt-2 space-y-1">
                ...
                <li>
                  All data is stored per Internet Identity in localStorage and

  ...
  const handleDelete = (id: string) => {
    if (confirm(t("gstData.confirmDelete"))) {
      deleteRecord.mutate(id, {
        ...
        onError: (error: any) =>
          toast.error(error.message || t("gstData.deleteFailed")),
      });
    }
  };
    ...
    <div className="space-y-6">
      ...
      {showImport && (
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              {t("gstData.importJsonDescription")}
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            <div className="flex gap-2">
              <Button
                ...
                disabled={createRecord.isPending || !importJson}
              >
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            {t("gstData.storedRecordsDescription")}
          </CardDescription>
        </CardHeader>
        <CardContent>
          {isLoading ? (

      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Comprehensive business insights with Indian accounting standards
            compliance
          </p>
        </div>
        ...
        <TabsContent value="financial-statements" className="space-y-4">
          <div className="flex items-center justify-between mb-4">
            <div className="flex gap-2">
              <Button
                variant={
                  financialStatementType === "schedule3" ? "default" : "outline"
                }
              ...
              <Button
                variant={
                  financialStatementType === "tabular" ? "default" : "outline"
                }

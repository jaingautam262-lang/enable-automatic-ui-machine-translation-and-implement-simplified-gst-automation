...
export default function FinancialRatioCalculator() {
  ...
  const [liquidityResults, setLiquidityResults] =
    useState<LiquidityRatios | null>(null);
  ...
  const [profitabilityResults, setProfitabilityResults] =
    useState<ProfitabilityRatios | null>(null);
  ...
  const [leverageResults, setLeverageResults] = useState<LeverageRatios | null>(
    null,
  );
  ...
  const [efficiencyResults, setEfficiencyResults] =
    useState<EfficiencyRatios | null>(null);

  const calculateLiquidity = () => {
    const currentAssets = Number.parseFloat(liquidityInputs.currentAssets);
    const currentLiabilities = Number.parseFloat(
      liquidityInputs.currentLiabilities,
    );
    const inventory = Number.parseFloat(liquidityInputs.inventory) || 0;
    const cash = Number.parseFloat(liquidityInputs.cash) || 0;
  ...
  const calculateProfitability = () => {
    const revenue = Number.parseFloat(profitabilityInputs.revenue);
    const cogs = Number.parseFloat(profitabilityInputs.cogs) || 0;
    const operatingExpenses =
      Number.parseFloat(profitabilityInputs.operatingExpenses) || 0;
    const netIncome = Number.parseFloat(profitabilityInputs.netIncome);
    const totalAssets = Number.parseFloat(profitabilityInputs.totalAssets);
    const equity = Number.parseFloat(profitabilityInputs.equity);
  ...
  const calculateLeverage = () => {
    const totalDebt = Number.parseFloat(leverageInputs.totalDebt);
    const totalEquity = Number.parseFloat(leverageInputs.totalEquity);
    const totalAssets = Number.parseFloat(leverageInputs.totalAssets);
    const ebit = Number.parseFloat(leverageInputs.ebit);
    const interestExpense = Number.parseFloat(leverageInputs.interestExpense);
  ...
  const calculateEfficiency = () => {
    const cogs = Number.parseFloat(efficiencyInputs.cogs);
    const avgInventory = Number.parseFloat(efficiencyInputs.avgInventory);
    const revenue = Number.parseFloat(efficiencyInputs.revenue);
    const avgReceivables = Number.parseFloat(efficiencyInputs.avgReceivables);
    const totalAssets = Number.parseFloat(efficiencyInputs.totalAssets);
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">
          Comprehensive ratio analysis for business performance evaluation
        </p>
      </div>
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Enter balance sheet data for liquidity analysis
                </CardDescription>
              </CardHeader>
                    ...
                    <TableBody>
                      <TableRow>
                        ...
                        <TableCell className="text-right">
                          {liquidityResults.currentRatio.toFixed(2)}
                        </TableCell>
                      ...
                      <TableRow>
                        ...
                        <TableCell className="text-right">
                          {liquidityResults.quickRatio.toFixed(2)}
                        </TableCell>
                        <TableCell className="text-right text-muted-foreground">
                          &gt; 1.0
                        </TableCell>
                      ...
                      <TableRow>
                        ...
                        <TableCell className="text-right">
                          {liquidityResults.cashRatio.toFixed(2)}
                        </TableCell>
                        <TableCell className="text-right text-muted-foreground">
                          &gt; 0.5
                        </TableCell>
                      ...
                      <TableRow>
                        ...
                        <TableCell className="text-right">
                          {formatINR(liquidityResults.workingCapital)}
                        </TableCell>
                        <TableCell className="text-right text-muted-foreground">
                          &gt; 0
                        </TableCell>
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Enter income statement and balance sheet data
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="space-y-2">
                  ...
                  <Table>
                    ...
                    <TableBody>
                      <TableRow>
                        ...
                        <TableCell className="text-right">
                          {profitabilityResults.grossMargin.toFixed(2)}%
                        </TableCell>
                        <TableCell className="text-right text-muted-foreground">
                          &gt; 30%
                        </TableCell>
                      ...
                      <TableRow>
                        ...
                        <TableCell className="text-right">
                          {profitabilityResults.netMargin.toFixed(2)}%
                        </TableCell>
                        <TableCell className="text-right text-muted-foreground">
                          &gt; 10%
                        </TableCell>
                      ...
                      <TableRow>
                        ...
                        <TableCell className="text-right">
                          {profitabilityResults.operatingMargin.toFixed(2)}%
                        </TableCell>
                        <TableCell className="text-right text-muted-foreground">
                          &gt; 15%
                        </TableCell>
                      ...
                      <TableRow>
                        ...
                        <TableCell className="text-right">
                          {profitabilityResults.roa.toFixed(2)}%
                        </TableCell>
                        <TableCell className="text-right text-muted-foreground">
                          &gt; 5%
                        </TableCell>
                      ...
                      <TableRow>
                        ...
                        <TableCell className="text-right">
                          {profitabilityResults.roe.toFixed(2)}%
                        </TableCell>
                        <TableCell className="text-right text-muted-foreground">
                          &gt; 15%
                        </TableCell>
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setLeverageInputs({
                        ...leverageInputs,
                        interestExpense: e.target.value,
                      })
                    }
                  />
                </div>
                  ...
                  <Table>
                    ...
                    <TableBody>
                      <TableRow>
                        ...
                        <TableCell className="text-right">
                          {leverageResults.debtToEquity.toFixed(2)}
                        </TableCell>
                        <TableCell className="text-right text-muted-foreground">
                          &lt; 2.0
                        </TableCell>
                      ...
                      <TableRow>
                        ...
                        <TableCell className="text-right">
                          {leverageResults.debtRatio.toFixed(2)}
                        </TableCell>
                        <TableCell className="text-right text-muted-foreground">
                          &lt; 0.6
                        </TableCell>
                      ...
                      <TableRow>
                        ...
                        <TableCell className="text-right">
                          {leverageResults.interestCoverage.toFixed(2)}
                        </TableCell>
                        <TableCell className="text-right text-muted-foreground">
                          &gt; 2.5
                        </TableCell>
                  ...
                  <Table>
                    ...
                    <TableBody>
                      <TableRow>
                        ...
                        <TableCell className="text-right">
                          {efficiencyResults.inventoryTurnover.toFixed(2)}x
                        </TableCell>
                        <TableCell className="text-right text-muted-foreground">
                          &gt; 5x
                        </TableCell>
                      ...
                      <TableRow>
                        ...
                        <TableCell className="text-right">
                          {efficiencyResults.receivableTurnover.toFixed(2)}x
                        </TableCell>
                        <TableCell className="text-right text-muted-foreground">
                          &gt; 6x
                        </TableCell>
                      ...
                      <TableRow>
                        ...
                        <TableCell className="text-right">
                          {efficiencyResults.assetTurnover.toFixed(2)}x
                        </TableCell>
                        <TableCell className="text-right text-muted-foreground">
                          &gt; 1x
                        </TableCell>
